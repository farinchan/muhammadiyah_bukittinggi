                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" aria-describedby="emailHelp"
                                        autocomplete="off" required name="title" value="{{ old('title') }}" autofocus>
                                    @error('title')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="my-editor" class="form-control">
                                        {!! old('content') !!}
                                    </textarea>
                                    @error('content')
                                        <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    @error('tags')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                    <small class="form-text text-muted">Tags digunakan untuk SEO, pisahkan dengan koma <code>(,)    </code> jika lebih dari satu keywoard yang digunakan</small>
                                </div>
