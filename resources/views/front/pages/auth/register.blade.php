                ...
                <div class="col-md-8">
                    @if ($setting_web->register_page)
                        <form method="POST" action="{{ route('register.process') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group-icon">
                                        ...
                                        <input type="text" placeholder="Kabupaten/Kota"
                                            onfocus="this.placeholder = ''" onblur="this.placeholder = 'Kabupaten/Kota'"
                                            required="" class="single-input @error('city') is-invalid @enderror"
                            ...
                            <div class="form-group row">
                                <label for="Kecamatan"
                                    class="col-md-3 col-form-label text-md-right">{{ __('Kecamatan') }}
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-md-8">
                                    <div class="input-group-icon">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group-icon">
                                        ...
                                        <select id="job" class="reset-style select2" name="job[]"
                                            ...
                                            <option value="Arsitek"@if (old('job') == 'Arsitek') selected @endif>
                                                Arsitek
                                            </option>
                                            <option value="Nelayan"@if (old('job') == 'Nelayan') selected @endif>
                                                Nelayan
                                            </option>
                                            <option value="Perawat"@if (old('job') == 'Perawat') selected @endif>
                                                Perawat
                                            </option>
                                            ...
                                            <option value="Masinis"@if (old('job') == 'Masinis') selected @endif>
                                                Masinis
                                            </option>
                                            <option value="Wartawan"@if (old('job') == 'Wartawan') selected @endif>
                                                Wartawan</option>
                                            <option value="Penulis"@if (old('job') == 'Penulis') selected @endif>
                                                Penulis
                                            </option>
                                            <option
                                                value="Insinyur Mesin"@if (old('job') == 'Insinyur Mesin') selected @endif>
                                                Insinyur Mesin</option>
                                            <option value="Ahli Gizi"@if (old('job') == 'Ahli Gizi') selected @endif>
                                                Ahli
                                                Gizi</option>
                                            ...
                                            <option value="Notaris"@if (old('job') == 'Notaris') selected @endif>
                                                Notaris
                                            </option>
                                            ...
                                            <option value="Penerjemah"@if (old('job') == 'Penerjemah') selected @endif>
                                                Penerjemah</option>
                                            <option value="Tentara"@if (old('job') == 'Tentara') selected @endif>
                                                Tentara
                                            </option>
                                            <option
                                                value="Tukang Cukur"@if (old('job') == 'Tukang Cukur') selected @endif>
                                                Tukang Cukur</option>
                                            <option value="Petani"@if (old('job') == 'Petani') selected @endif>
                                                Petani
                                            </option>
                                            <option value="Akuntan"@if (old('job') == 'Akuntan') selected @endif>
                                                Akuntan
                                            </option>
                                            <option value="Pengacara"@if (old('job') == 'Pengacara') selected @endif>
                                                Pengacara</option>
                                            <option value="Polisi"@if (old('job') == 'Polisi') selected @endif>
                                                Polisi
                                            </option>
                                            <option
                                                value="Pegawai Negeri"@if (old('job') == 'Pegawai Negeri') selected @endif>
                                                Pegawai Negeri</option>
                                            <option
                                                value="Pegawai Swasta"@if (old('job') == 'Pegawai Swasta') selected @endif>
                                                Pegawai Swasta</option>
                                            <option value="Wiraswasta"@if (old('job') == 'Wiraswasta') selected @endif>
                                                Wiraswasta</option>
                                            <option value="Lainnya"@if (old('job') == 'Lainnya') selected @endif>
                                                Lainnya
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group-icon">
                                        ...
                                        <select name="ktam" id="ktam"
                                            ...
                                            <option value="Tidak Ada" @if (old('ktam') == 'Tidak Ada') selected @endif>
                                                Tidak
                                                Ada</option>
                                        </select>
                                    </div>
