            ...
            <div class="row">
                <div class="col-md-9">
                    <form method="POST" action="{{ route('register.process') }}">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="switch-wrap d-flex">
                                            ...
                                            Saya menyetujui &nbsp;
                                            <a class="text-info" href="#"> Syarat dan Ketentuan</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <p class="text-center mt-3">Belum punya akun? <a class="text-info"
                ...
                <div class="col-md-3">
                    ...
                    <p>
                        Dengan membuat akun, Anda dapat mengakses semua fitur yang ada di website kami. Jadi, tunggu apalagi?
                        Daftar sekarang!
