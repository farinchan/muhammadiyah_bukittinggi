                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                        <thead>
                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-70px">Kajian</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            @foreach ($comments as $comment)
                                <tr>
                                    ...
                                    <td class="text-end" >
                                        <a href="#" class="text-gray-600 fw-bold text-hover-primary">{{ $comment->kajian->title }}</a>
                                        <br>
                                    ...
                                    <td class="text-end" >
                                        ...
                                        @endif
                                        <br>
                                        <span class="text-muted fw-bold">{{ $comment->kajian->created_at->format('d/m/Y') }}</span>
                                    </td>
                                    <td class="text-end">
                                        <form style="display: inline-block;"
                                            action="{{ route('admin.kajian.comment.spam', $comment->id) }}"
                                            method="POST">
                                            @csrf
