            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('admin.letter.out.create') }}" class="btn btn-primary">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route("admin.letter.out.edit", $letter->id) }}" class="menu-link px-3">
                                                    Edit</a>
                                            </div>
                                            <div class="menu-item px-3">
        ...
        <div class="modal fade" tabindex="-1" id="delete_category{{ $letter->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.letter.out.destroy', $letter->id) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">
                                <p>Apakah Anda yakin ingin menghapus Surat <strong>{{ $letter->name }}</strong>?</p>
                            </div>
                        </div>
